...
**PyKotor (read/write):** [`Libraries/PyKotor/src/pykotor/resource/formats/rim/io_rim.py`](https://github.com/OldRepublicDevs/PyKotor/tree/master/Libraries/PyKotor/src/pykotor/resource/formats/rim/io_rim.py)

**PyKotor (data model):** [`Libraries/PyKotor/src/pykotor/resource/formats/rim/rim_data.py`](https://github.com/OldRepublicDevs/PyKotor/tree/master/Libraries/PyKotor/src/pykotor/resource/formats/rim/rim_data.py)

**Vendor references (original first, mirror second):**

- **[Kotor.NET](https://github.com/NickHugi/Kotor.NET)** ([Mirror: th3w1zard1/Kotor.NET](https://github.com/th3w1zard1/Kotor.NET)): [`Kotor.NET/Formats/KotorRIM/`](https://github.com/NickHugi/Kotor.NET/tree/master/Kotor.NET/Formats/KotorRIM) — RIM binary structures and reader/writer API.
