...
_lr_action_items = {
    "INCLUDE": ([0, 1, 2, 3, 4, 5, 6, 7, 8, 25, 28, 63, 103, 134, 171], [-2, 10, -1, -3, -4, -5, -6, -7, -8, -13, -15, -14, -16, -9, -17]),
    "STRUCT": (
        [
            0,
            1,
    ...
    "$end": ([0, 1, 2, 3, 4, 5, 6, 7, 8, 25, 28, 63, 103, 134, 171], [-2, 0, -1, -3, -4, -5, -6, -7, -8, -13, -15, -14, -16, -9, -17]),
    "IDENTIFIER": (
        [
            9,
            11,
...
_lr_goto_items = {
    ...
    "code_block": ([102, 138, 179, 204, 215, 219, 236, 246], [139, 170, 197, 213, 223, 227, 244, 251]),
    "statement": (
