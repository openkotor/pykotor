...
_lr_action_items = {
    ...
    "=": ([24, 35, 44, 57, 107, 132, 169], [29, -119, 88, 101, -120, -121, 189]),
    "{": (
        [
            26,
            58,
...
_lr_goto_items = {
    "code_root": ([0], [1]),
    "code_root_object": ([1], [2]),
    "function_definition": ([1], [3]),
    "include_script": ([1], [4]),
    "function_forward_declaration": ([1], [5]),
    "global_variable_declaration": ([1], [6]),
    "global_variable_initialization": ([1], [7]),
    "struct_definition": ([1], [8]),
    "data_type": (
        [
            1,
            27,
    ...
    "function_definition_params": ([27], [32]),
    "function_definition_param": ([27, 59], [33, 104]),
    "expression": (
        [
            29,
            37,
    ...
    "struct_members": ([30], [56]),
    "struct_member": ([56], [99]),
    "function_call_params": ([61], [105]),
    "code_block": (
...
_lr_productions = [
    ...
    (
        "code_root_object -> function_forward_declaration",
        "code_root_object",
        1,
        "p_code_root_object",
        "parser.py",
    ...
    (
        "code_root_object -> global_variable_declaration",
        "code_root_object",
        1,
        "p_code_root_object",
        "parser.py",
    ...
    (
        "code_root_object -> global_variable_initialization",
        "code_root_object",
        1,
        "p_code_root_object",
        "parser.py",
    ...
    (
        "code_root_object -> struct_definition",
        "code_root_object",
        1,
        "p_code_root_object",
        "parser.py",
    ...
    (
        "function_definition_params -> <empty>",
        "function_definition_params",
        0,
        "p_function_definition_params",
        "parser.py",
    ...
    (
        ...
        "variable_declarator",
        1,
        "p_variable_declarator_no_initializer",
        "parser.py",
        308,
    ),
    (
    ...
    (
        "expression -> expression GREATER_THAN_OR_EQUALS expression",
        "expression",
        3,
        "p_binary_operator",
        "parser.py",
    ...
    (
        "expression -> expression LESS_THAN_OR_EQUALS expression",
        "expression",
        3,
        "p_binary_operator",
        "parser.py",
    ...
    (
        "expression -> expression BITWISE_XOR expression",
        "expression",
        3,
        "p_binary_operator",
        "parser.py",
    ...
    (
        "expression -> expression BITWISE_LEFT expression",
        "expression",
        3,
        "p_binary_operator",
        "parser.py",
    ...
    (
        "expression -> expression BITWISE_RIGHT expression",
        "expression",
        3,
        "p_binary_operator",
        "parser.py",
    ...
    (
        "constant_expression -> FLOAT_VALUE",
        "constant_expression",
        1,
        "p_constant_expression",
        "parser.py",
    ...
    (
        "constant_expression -> STRING_VALUE",
        "constant_expression",
        1,
        "p_constant_expression",
        "parser.py",
    ...
    (
        "constant_expression -> OBJECTSELF_VALUE",
        "constant_expression",
        1,
        "p_constant_expression",
        "parser.py",
    ...
    (
        "constant_expression -> OBJECTINVALID_VALUE",
        "constant_expression",
        1,
        "p_constant_expression",
        "parser.py",
    ...
    (
        "constant_expression -> TRUE_VALUE",
        "constant_expression",
        1,
        "p_constant_expression",
        "parser.py",
    ...
    (
        "constant_expression -> FALSE_VALUE",
        "constant_expression",
        1,
        "p_constant_expression",
        "parser.py",
    ...
    (
        "constant_expression -> INT_HEX_VALUE",
        "constant_expression",
        1,
        "p_constant_expression",
        "parser.py",
    ...
    (
        "field_access -> field_access . IDENTIFIER",
        "field_access",
        3,
        "p_field_access",
        "parser.py",
    ...
    (
        ...
        "expression",
        2,
        "p_postfix_increment_expression",
        "parser.py",
        566,
    ),
    (
    ...
    (
        ...
        "expression",
        2,
        "p_postfix_decrement_expression",
        "parser.py",
        578,
    ),
    (
