...
References:
----------
    Libraries/PyKotor/src/pykotor/engine/panda3d/mdl_loader.py - MDL loader implementation
...
class TestAnimationControllers(unittest.TestCase):
    ...
    References:
    ----------
        Libraries/PyKotor/src/pykotor/engine/animation/animation_controller.py
    ...
    def test_position_controller(self):
        ...
        References:
        ----------
            Libraries/PyKotor/src/pykotor/engine/animation/animation_controller.py:165-228
