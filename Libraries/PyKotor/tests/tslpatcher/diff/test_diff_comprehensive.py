"""Unit Tests for TSLPatcher diff generation and INI writer.
...
class Test2DAMemory(unittest.TestCase):
    """Tests for 2DAMEMORY token generation and usage."""
...
class TestTLKStrRef(unittest.TestCase):
...
class TestInstallList(unittest.TestCase):
    """Tests for InstallList generation."""
