...
class TestCaseInsensImmutableStr(unittest.TestCase):
    ...
    def test_capitalize(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.capitalize, str.capitalize, "hello", "Hello"
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.capitalize, str.capitalize, "HELLO", "Hello"
        )
    ...
    def test_casefold(self):
        ...
        self.assert_ciws_function(CaseInsensImmutableStr.casefold, str.casefold, "hElLo", "hello")
        self.assert_ciws_function(
            CaseInsensImmutableStr.casefold, str.casefold, "Straße", "strasse"
        )

    def test_center(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.center, str.center, "hello", "  hello  ", 9
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.center, str.center, "hello", "**hello**", 9, "*"
        )
    ...
    def test_count(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.count, str.count, "hello hello", 2, "hello"
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.count, str.count, "hello hello", 2, "HELLO"
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.count, str.count, "hello hello", 1, "hello", 3
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.count, str.count, "hello hello", 0, "world"
        )

    def test_encode(self):
        self.assert_ciws_function(CaseInsensImmutableStr.encode, str.encode, "hello", b"hello")
        self.assert_ciws_function(
            CaseInsensImmutableStr.encode, str.encode, "hello", b"hello", "utf-8"
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.encode,
            str.encode,
            "こんにちは",
    ...
    def test_endswith(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.endswith, str.endswith, "hello", True, "lo"
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.endswith, str.endswith, "hello", True, "LO"
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.endswith, str.endswith, "hello", False, "he"
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.endswith, str.endswith, "hello", True, ("lo", "LO")
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.endswith, str.endswith, "hello", True, "lo", 2
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.endswith, str.endswith, "hello", False, "lo", 0, 3
        )

    def test_expandtabs(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.expandtabs, str.expandtabs, "hello\tworld", "hello   world"
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.expandtabs, str.expandtabs, "hello\tworld", "hello world", 1
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.expandtabs, str.expandtabs, "\t", "        "
        )
    ...
    def test_format(self):
        ...
        self.assert_ciws_function(
            CaseInsensImmutableStr.format, str.format, "{} {}", "Hello World", "Hello", "World"
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.format, str.format, "{:>10}", "     Hello", "Hello"
        )

    def test_format_map(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.format_map,
            str.format_map,
            "Hello, {name}!",
            "Hello, World!",
            {"name": "World"},
        ...
        self.assert_ciws_function(
            CaseInsensImmutableStr.format_map, str.format_map, "{a} {b}", "1 2", {"a": 1, "b": 2}
        )

    def test_index(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.index, str.index, "hello", 2, "l", _basic__=True
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.index, str.index, "hello", 2, "L", _basic__=True
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.index, str.index, "hello", 4, "o", 4, _basic__=True
        )
    ...
    def test_isidentifier(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.isidentifier, str.isidentifier, "hello", True
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.isidentifier, str.isidentifier, "hello123", True
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.isidentifier, str.isidentifier, "123hello", False
        )
    ...
    def test_isprintable(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.isprintable, str.isprintable, "Hello, World!", True
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.isprintable, str.isprintable, "Hello\nWorld", False
        )
    ...
    def test_join(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.join, str.join, ",", "a,b,c", ["a", "b", "c"]
        )
    ...
    def test_ljust(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.ljust, str.ljust, "hello", "hello     ", 10
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.ljust, str.ljust, "hello", "hello*****", 10, "*"
        )
    ...
    def test_lstrip(self):
        ...
        self.assert_ciws_function(
            CaseInsensImmutableStr.lstrip, str.lstrip, "00hello", "hello", "0"
        )
        self.assert_ciws_function(CaseInsensImmutableStr.lstrip, str.lstrip, "hello", "hello")

    def test_partition(self):
        assert tuple(str(x) for x in CaseInsensImmutableStr("hello world").partition(" ")) == (
            "hello",
            " ",
            "world",
        )
        assert tuple(str(x) for x in CaseInsensImmutableStr("hello").partition("world")) == (
            "hello",
            "",
            "",
        )
        assert tuple(str(x) for x in CaseInsensImmutableStr("hello WORLD").partition("world")) == (
            "hello ",
            "WORLD",
            "",
        )
    ...
    @unittest.skipIf(
        ...
        f"removeprefix not available in python v{sys.version_info}",
    )
    def test_removeprefix(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.removeprefix, str.removeprefix, "HelloWorld", "World", "Hello"
        )  # pyright: ignore[reportAttributeAccessIssue]
        self.assert_ciws_function(
            CaseInsensImmutableStr.removeprefix,
            str.removeprefix,
            "HelloWorld",
            "HelloWorld",
            "HELLO",
    ...
    @unittest.skipIf(
        not hasattr(str, "removesuffix"),
        f"removeprefix not available in python v{sys.version_info}",
    )
    def test_removesuffix(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.removesuffix, str.removesuffix, "HelloWorld", "Hello", "World"
        )  # pyright: ignore[reportAttributeAccessIssue]
        self.assert_ciws_function(
            CaseInsensImmutableStr.removesuffix,
            str.removesuffix,
            "HelloWorld",
            "HelloWorld",
            "WORLD",
    ...
    def test_replace(self):
        ...
        assert str(ciws.replace("e", "a")) == CaseInsensImmutableStr("tast"), (
            'str(ciws.replace("e", "a")) != CaseInsensImmutableStr("tast")'
        )
        assert (
        ...
        assert str(str(ciws.replace("e", "a"))).lower() == "tast".lower(), (
            'str(str(ciws.replace("e", "a"))).lower() != str("tast").lower()'
        )

        assert str(ciws.replace("", "x")) == CaseInsensImmutableStr("xtxexsxtx"), (
            'str(ciws.replace("", "x")) != CaseInsensImmutableStr("xtxexsxtx")'
        )
        assert (
            str(str(ciws.replace("", "x"))).lower()
            == str(CaseInsensImmutableStr("xtxexsxtx")).lower()
        ), (
            'str(str(ciws.replace("", "x"))).lower() != str(CaseInsensImmutableStr("xtxexsxtx")).lower()'
        )
        assert str(ciws.replace("", "x")) == "xtxexsxtx", (
            'str(ciws.replace("", "x")) != "xtxexsxtx"'
        )
        assert str(str(ciws.replace("", "x"))).lower() == "xtxexsxtx".lower(), (
            'str(str(ciws.replace("", "x"))).lower() != str("xtxexsxtx").lower()'
        )

        assert str(ciws.replace("T", "x")) == "xesx", 'str(ciws.replace("T", "x")) != "xesx"'
        assert str(str(ciws.replace("T", "x"))).lower() == "xesx".lower(), (
            'str(str(ciws.replace("T", "x"))).lower() != str("xesx").lower()'
        )
        assert str(ciws.replace("E", "a")) == "tast", 'str(ciws.replace("E", "a")) != "tast"'
        assert str(str(ciws.replace("E", "a"))).lower() == "tast".lower(), (
            'str(str(ciws.replace("E", "a"))).lower() != str("tast").lower()'
        ...
        assert str(longer.replace("test", "exam")) == "exam exam EXAM", (
            'str(longer.replace("test", "exam")) != "exam exam EXAM"'
        )
        ...
        assert str(longer.replace("test", "exam", 2)) == "exam exam TEST", (
            'str(longer.replace("test", "exam", 2)) != "exam exam TEST"'
        )
        ...
        assert str(str(ciws.replace("t", "x", 1))).lower() == "xest".lower(), (
            'str(str(ciws.replace("t", "x", 1))).lower() != str("xest").lower()'
        )

        assert str(ciws.replace("z", "a")) == "test", 'str(ciws.replace("z", "a")) != "test"'
        assert str(str(ciws.replace("z", "a"))).lower() == "test".lower(), (
            'str(str(ciws.replace("z", "a"))).lower() != str("test").lower()'
        )

        assert str(ciws.replace("t", "")) == "es", 'str(ciws.replace("t", "")) != "es"'
        assert str(str(ciws.replace("t", ""))).lower() == "es".lower(), (
            'str(str(ciws.replace("t", ""))).lower() != str("es").lower()'
        )
        ...
        self.assert_ciws_function(
            CaseInsensImmutableStr.replace,
            str.replace,
            "hello world",
            "hello universe",
            "world",
    ...
    def test_rfind(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.rfind,
            str.rfind,
            "hello",
            3,
            "l",
            _basic__=True,
            _compare_str_result__=True,
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.rfind,
            str.rfind,
    ...
    def test_rjust(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.rjust, str.rjust, "hello", "     hello", 10
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.rjust, str.rjust, "hello", "*****hello", 10, "*"
        )
    ...
    def test_rpartition(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.rpartition,
            str.rpartition,
            "hello world world",
            ("hello world ", "world", ""),
            "world",
        ...
        self.assert_ciws_function(
            CaseInsensImmutableStr.rpartition, str.rpartition, "hello", ("", "", "hello"), "world"
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.rpartition,
            str.rpartition,
    ...
    def test_rsplit(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.rsplit, str.rsplit, "hello world", ["hello", "world"]
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.rsplit, str.rsplit, "hello  world", ["hello", "world"]
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.rsplit,
            str.rsplit,
            "hello world world",
            ["hello world", "world"],
            None,
    ...
    def test_rstrip(self):
        ...
        self.assert_ciws_function(
            CaseInsensImmutableStr.rstrip, str.rstrip, "hello00", "hello", "0"
        )
        self.assert_ciws_function(CaseInsensImmutableStr.rstrip, str.rstrip, "hello", "hello")

    def test_split(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.split, str.split, "hello world", ["hello", "world"]
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.split, str.split, "hello  world", ["hello", "world"]
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.split,
            str.split,
            "hello world world",
            ["hello", "world world"],
            None,
    ...
    def test_splitlines(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.splitlines, str.splitlines, "hello\nworld", ["hello", "world"]
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.splitlines, str.splitlines, "hello\r\nworld", ["hello", "world"]
        )
        ...
        self.assert_ciws_function(
            CaseInsensImmutableStr.splitlines,
            str.splitlines,
            "hello\nworld\n",
            ["hello\n", "world\n"],
            True,
    ...
    def test_startswith(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.startswith, str.startswith, "hello", True, "he"
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.startswith, str.startswith, "hello", True, "HE"
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.startswith, str.startswith, "hello", False, "wo"
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.startswith, str.startswith, "hello", True, ("he", "wo")
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.startswith, str.startswith, "hello", True, "el", 1
        )

    def test_strip(self):
        self.assert_ciws_function(CaseInsensImmutableStr.strip, str.strip, "  hello  ", "hello")
        self.assert_ciws_function(
            CaseInsensImmutableStr.strip, str.strip, "00hello00", "hello", "0"
        )
        self.assert_ciws_function(CaseInsensImmutableStr.strip, str.strip, "hello", "hello")
    ...
    def test_swapcase(self):
        ...
        self.assert_ciws_function(
            CaseInsensImmutableStr.swapcase, str.swapcase, "Hello World", "hELLO wORLD"
        )
        self.assert_ciws_function(CaseInsensImmutableStr.swapcase, str.swapcase, "12345", "12345")

    def test_title(self):
        self.assert_ciws_function(
            CaseInsensImmutableStr.title, str.title, "hello world", "Hello World"
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.title, str.title, "HELLO WORLD", "Hello World"
        )
        self.assert_ciws_function(
            CaseInsensImmutableStr.title, str.title, "hello123 world123", "Hello123 World123"
        )

    def test_translate(self):
        trans_table = str.maketrans("aeiou", "AEIOU")
        self.assert_ciws_function(
            CaseInsensImmutableStr.translate,
            str.translate,
            "hello world",
            "hEllO wOrld",
            trans_table,
        ...
        self.assert_ciws_function(
            CaseInsensImmutableStr.translate, str.translate, "hello world", "hll wrld", delete_table
        )
