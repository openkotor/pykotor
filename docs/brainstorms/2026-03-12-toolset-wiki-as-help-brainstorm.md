...
- **Update pipelines:** In-app “check for updates” for help should fetch from **OldRepublicDevs/PyKotor** (e.g. main repo’s wiki or GitHub wiki), not th3w1zard1 or a pre-built help.zip at a fixed path.
...
- Aligns help source with project home (OldRepublicDevs/PyKotor) and ensures compile and packaging use the same wiki content.
...
- **Help updater:** Change download source to OldRepublicDevs/PyKotor (URL/artifact to be chosen: e.g. wiki repo tarball or CI-built zip of repo `wiki/`).
