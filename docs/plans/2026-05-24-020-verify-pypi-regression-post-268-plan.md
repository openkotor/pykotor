...
**Last CI check (plan 213):** 2026-05-29 — verify [26549547772](https://github.com/OpenKotOR/PyKotor/actions/runs/26549547772) success on `ca61ce8`; FC [26549293445](https://github.com/OpenKotOR/PyKotor/actions/runs/26549293445) failure on `ca61ce8`.

**Plans:** 019–213 document the closeout track; authoritative learning in `docs/solutions/testing/verify-pypi-regression-closeout.md`.
