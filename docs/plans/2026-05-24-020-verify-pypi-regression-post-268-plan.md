...
| Verify PyPI CI (post-#277) | https://github.com/OpenKotOR/PyKotor/actions/runs/26372746392 | ⏳ queued — **Check trigger** on `8916e2ffe` (plan 066; cancelled stale 26365458400 after plan 065 drift detection) |
