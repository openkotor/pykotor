...
| Check | Expected |
|-------|----------|
| workflow_dispatch | jobs scheduled (not empty cancelled) |
| failed workflow_run | gate succeeds; test jobs skipped; workflow not cancelled |
| Local discovery | unchanged (holopatcher, kotordiff, kotormcp) |
