# Form implementation generated from reading ui file 'c:\GitHub\Andastra\vendor\pykotor\Tools\HolocronToolset\src\ui\widgets\settings\installations.ui'
#
...
class Ui_Form:
    def setupUi(self, Form):
        ...
        self.pathDirWidget = QtWidgets.QWidget(parent=self.pathFrame)
        self.pathDirWidget.setObjectName("pathDirWidget")
        self.pathDirLayout = QtWidgets.QHBoxLayout(self.pathDirWidget)
        self.pathDirLayout.setObjectName("pathDirLayout")
        self.pathDirEdit = QtWidgets.QLineEdit(parent=self.pathDirWidget)
        self.pathDirEdit.setObjectName("pathDirEdit")
        self.pathDirLayout.addWidget(self.pathDirEdit)
        self.pathBrowseButton = QtWidgets.QPushButton(parent=self.pathDirWidget)
        self.pathBrowseButton.setObjectName("pathBrowseButton")
        self.pathDirLayout.addWidget(self.pathBrowseButton)
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.pathDirWidget)
