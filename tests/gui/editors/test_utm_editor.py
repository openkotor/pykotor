"""
Unit Tests for UTM Editor - testing EVERY possible manipulation.
...
def test_utm_editor_empty_strings(qtbot: QtBot, installation: HTInstallation, test_files_dir: Path):
...
def test_utm_editor_new_file_creation(qtbot: QtBot, installation: HTInstallation):
...
def test_utm_editor_new_file_all_defaults(qtbot: QtBot, installation: HTInstallation):
