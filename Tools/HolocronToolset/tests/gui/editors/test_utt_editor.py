"""
Unit Tests for UTT Editor - testing EVERY possible manipulation.
...
def test_utteditor_editor_help_dialog_opens_correct_file(qtbot, installation: HTInstallation):
    ...
    assert "Help File Not Found" not in html, f"Help file 'GFF-UTT.md' should be found, but error was shown. HTML: {html[:500]}"
