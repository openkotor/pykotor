...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pathDirWidget = QtWidgets.QWidget(self.pathFrame)
        ...
        self.pathDirEdit = QtWidgets.QLineEdit(self.pathDirWidget)
        self.pathDirEdit.setObjectName("pathDirEdit")
        self.pathDirLayout.addWidget(self.pathDirEdit)
        self.pathBrowseButton = QtWidgets.QPushButton(self.pathDirWidget)
        self.pathBrowseButton.setObjectName("pathBrowseButton")
        self.pathDirLayout.addWidget(self.pathBrowseButton)
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.pathDirWidget)
