...
class Ui_MediaPlayerWidget(object):
    def setupUi(self, MediaPlayerWidget):
        ...
        self.playPauseButton = QtWidgets.QPushButton(parent=MediaPlayerWidget)
        self.playPauseButton.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        ...
        self.stopButton = QtWidgets.QPushButton(parent=MediaPlayerWidget)
        ...
        self.timeSlider = QtWidgets.QSlider(parent=MediaPlayerWidget)
        self.timeSlider.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.timeSlider.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        ...
        self.timeLabel = QtWidgets.QLabel(parent=MediaPlayerWidget)
        ...
        self.volumeContainer = QtWidgets.QWidget(parent=MediaPlayerWidget)
        ...
        self.muteButton = QtWidgets.QPushButton(parent=self.volumeContainer)
        self.muteButton.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        ...
        self.volumeSlider = QtWidgets.QSlider(parent=self.volumeContainer)
        ...
        self.speedButton = QtWidgets.QToolButton(parent=MediaPlayerWidget)
        self.speedButton.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.speedButton.setMinimumSize(QtCore.QSize(50, 28))
        self.speedButton.setMaximumSize(QtCore.QSize(50, 28))
        self.speedButton.setPopupMode(QtWidgets.QToolButton.ToolButtonPopupMode.InstantPopup)
