...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.treeButton = QtWidgets.QPushButton(parent=Widget)
        ...
        self.graphButton = QtWidgets.QPushButton(parent=Widget)
        ...
        self.stack = QtWidgets.QStackedWidget(parent=Widget)
