...
class Ui_LYTEditor(object):
    def setupUi(self, LYTEditor):
        ...
        self.viewStack = QtWidgets.QStackedWidget(parent=self.leftWidget)
        ...
        self.graphicsView = QtWidgets.QGraphicsView(parent=self.topDownPage)
        self.graphicsView.setDragMode(QtWidgets.QGraphicsView.ScrollHandDrag)
        self.graphicsView.setRenderHints(QtGui.QPainter.RenderHint.Antialiasing|QtGui.QPainter.RenderHint.SmoothPixmapTransform)
        ...
        self.openGLWidget = QtWidgets.QWidget(parent=self.threeDPage)
