...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.nameLabel = QtWidgets.QLabel(parent=self.tab)
        ...
        self.tagLabel = QtWidgets.QLabel(parent=self.tab)
        self.tagLabel.setObjectName("tagLabel")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.tagLabel)
        ...
        self.resrefLabel = QtWidgets.QLabel(parent=self.tab)
        self.resrefLabel.setObjectName("resrefLabel")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.resrefLabel)
        ...
        self.descriptionLabel = QtWidgets.QLabel(parent=self.tab)
        ...
        self.baseItemLabel = QtWidgets.QLabel(parent=self.tab)
        self.baseItemLabel.setObjectName("baseItemLabel")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.baseItemLabel)
        ...
        self.costLabel = QtWidgets.QLabel(parent=self.tab)
        self.costLabel.setObjectName("costLabel")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.LabelRole, self.costLabel)
        ...
        self.addCostLabel = QtWidgets.QLabel(parent=self.tab)
        self.addCostLabel.setObjectName("addCostLabel")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.LabelRole, self.addCostLabel)
        ...
        self.upgradeLvlLabel = QtWidgets.QLabel(parent=self.tab)
        self.upgradeLvlLabel.setObjectName("upgradeLvlLabel")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.ItemRole.LabelRole, self.upgradeLvlLabel)
        ...
        self.labelPlot = QtWidgets.QLabel(parent=self.tab)
        self.labelPlot.setObjectName("labelPlot")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.ItemRole.LabelRole, self.labelPlot)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.ItemRole.FieldRole, self.plotCheckbox)
        self.labelCharges = QtWidgets.QLabel(parent=self.tab)
        self.labelCharges.setObjectName("labelCharges")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.ItemRole.LabelRole, self.labelCharges)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.ItemRole.FieldRole, self.chargesSpin)
        self.labelStack = QtWidgets.QLabel(parent=self.tab)
        self.labelStack.setObjectName("labelStack")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.ItemRole.LabelRole, self.labelStack)
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.ItemRole.FieldRole, self.stackSpin)
        self.labelModelVar = QtWidgets.QLabel(parent=self.tab)
        self.labelModelVar.setObjectName("labelModelVar")
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.ItemRole.LabelRole, self.labelModelVar)
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.ItemRole.FieldRole, self.modelVarSpin)
        self.labelBodyVar = QtWidgets.QLabel(parent=self.tab)
        self.labelBodyVar.setObjectName("labelBodyVar")
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.ItemRole.LabelRole, self.labelBodyVar)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.ItemRole.FieldRole, self.bodyVarSpin)
        self.labelTextureVar = QtWidgets.QLabel(parent=self.tab)
        self.labelTextureVar.setObjectName("labelTextureVar")
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.ItemRole.LabelRole, self.labelTextureVar)
        ...
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.ItemRole.FieldRole, self.textureVarSpin)
        self.horizontalLayout.addLayout(self.formLayout)
        self.verticalLayout_icon = QtWidgets.QVBoxLayout()
        self.verticalLayout_icon.setObjectName("verticalLayout_icon")
        self.iconGroupBox = QtWidgets.QGroupBox(parent=self.tab)
        ...
        self.iconLabel = QtWidgets.QLabel(parent=self.iconGroupBox)
        ...
        self.availPropLabel = QtWidgets.QLabel(parent=self.tab_2)
        ...
        self.propertyLabel = QtWidgets.QLabel(parent=self.tab_2)
...
"                the module. Engine reads via ReadFieldCExoString in LoadDataFromGff. Scripts use GetItemByTag to target this item. Modders: leave blank for\n"
...
"              properties from GFF PropertiesList; each entry has PropertyName (WORD), Subtype (WORD),\n"
"              CostTable (BYTE), CostValue (WORD), Param1, Param1Value, ChanceAppear (BYTE), Useable (BYTE).\n"
