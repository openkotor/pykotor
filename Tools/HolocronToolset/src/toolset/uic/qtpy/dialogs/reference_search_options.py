...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.patternGroup = QtWidgets.QGroupBox(parent=Dialog)
        ...
        self.patternLabel = QtWidgets.QLabel(parent=self.patternGroup)
        self.patternLabel.setObjectName("patternLabel")
        self.patternLayout.addWidget(self.patternLabel)
        self.filePatternEdit = QtWidgets.QLineEdit(parent=self.patternGroup)
        ...
        self.typesGroup = QtWidgets.QGroupBox(parent=Dialog)
        ...
        self.typesLabel = QtWidgets.QLabel(parent=self.typesGroup)
        self.typesLabel.setObjectName("typesLabel")
        self.typesLayout.addWidget(self.typesLabel)
        self.fileTypesScrollArea = QtWidgets.QScrollArea(parent=self.typesGroup)
