...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.stringrefSearchButton = QtWidgets.QPushButton(parent=self.frame)
        self.stringrefSearchButton.setMaximumSize(QtCore.QSize(40, 16777215))
        self.stringrefSearchButton.setObjectName("stringrefSearchButton")
        self.horizontalLayout_2.addWidget(self.stringrefSearchButton)
        self.stringrefOpenTLKButton = QtWidgets.QPushButton(parent=self.frame)
        self.stringrefOpenTLKButton.setMaximumSize(QtCore.QSize(40, 16777215))
        self.stringrefOpenTLKButton.setObjectName("stringrefOpenTLKButton")
        self.horizontalLayout_2.addWidget(self.stringrefOpenTLKButton)
